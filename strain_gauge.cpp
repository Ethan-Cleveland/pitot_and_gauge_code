...
// Variables
const int DT_pin = 19; //The pin on the arduino that is connected to the DT pin on the amplifier
const int SCK_pin = 18; //The pin on the arduino that is connected to the SCK pin on the amplifier
